...
class ProductsController extends Controller
{
    ...
    public function index(IndexProduct $request)
    {
        ...
        $data = AdminListing::create(Product::class)->processRequestAndGet(
            ...
            ['assets', 'brand_id', 'color', 'id', 'name', 'price', 'shortName', 'sizes', 'type'],

            // set columns to searchIn
            ['assets', 'color', 'description', 'id', 'name', 'shortName', 'sizes', 'type']
        );
    ...
    public function create()
    {
        ...
        return view('admin.product.create', compact('brands', 'sizes', 'colors', 'types'));
    }
    ...
    public function store(StoreProduct $request)
    {
        ...
        $sanitized['assets'] = [
            "type" => "picture", "path" => "assets/images/sneaker_01.png",
            "type" => "picture", "path" => "assets/images/sneaker_02.png",
            "type" => "picture", "path" => "assets/images/sneaker_03.png",
            "type" => "video",   "path" => "assets/images/sneaker_04.png",
        ];
    ...
    public function edit(Product $product)
    {
        ...
        $colors = Product::getColors();
        $types = Product::getTypes();
        $product->color = Product::getColors($product->color);
