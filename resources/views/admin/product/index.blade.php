                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'assets'">{{ trans('admin.product.columns.assets') }}</th>
                                        <th is='sortable' :column="'brand_id'">{{ trans('admin.product.columns.brand_id') }}</th>
                                        <th is='sortable' :column="'color'">{{ trans('admin.product.columns.color') }}</th>
                                        ...
                                        <th is='sortable' :column="'shortName'">{{ trans('admin.product.columns.shortName') }}</th>
                                        <th is='sortable' :column="'sizes'">{{ trans('admin.product.columns.sizes') }}</th>
                                        <th is='sortable' :column="'type'">{{ trans('admin.product.columns.type') }}</th>
